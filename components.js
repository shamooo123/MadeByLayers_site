        ...
        <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-black/90 backdrop-blur-md py-4 shadow-lg border-b border-zinc-800' : 'bg-transparent py-6'}`}>
            <div className="container mx-auto px-6 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    <a href="index.html" className="w-10 h-10 bg-yellow-400 rounded-lg overflow-hidden flex items-center justify-center border-2 border-yellow-500">
                         {/* Logo with Fallback */}
                         <img src="./madebylayers_transparent.png" alt="Logo" className="w-full h-full object-cover" onError={(e) => {e.target.style.display='none'; e.target.nextSibling.style.display='block'}} />
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    <a href="index.html#contact" className="px-6 py-2 bg-yellow-400 text-black font-bold rounded hover:bg-yellow-500 transition-all transform hover:scale-105">
                        GET QUOTE
                    </a>
                </div>
             ...
             {isOpen && (
                <div className="md:hidden bg-zinc-900 absolute top-full left-0 w-full border-b border-zinc-800 shadow-2xl animate-fade-in">
                    <div className="flex flex-col p-6 space-y-4">
                        ...
                        <a href="index.html#contact" className="bg-white/10 p-3 text-center rounded text-white font-bold">Get a Quote</a>
                    </div>
                </div>
            )}
        </nav>
                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-6 max-w-sm">
                            Bridging the gap between digital design and physical reality. Trusted by over 1,000 customers on eBay, now direct to you.
                        </p>
                        <div className="flex items-center gap-4">
                            <a href="#" className="p-2 bg-zinc-900 rounded-full hover:bg-yellow-400 hover:text-black transition-colors"><Icons.Instagram size={20} /></a>
                            <a href="#" className="p-2 bg-zinc-900 rounded-full hover:bg-yellow-400 hover:text-black transition-colors"><Icons.Mail size={20} /></a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400 text-sm">
                            <li><a href="#" className="hover:text-yellow-400 transition-colors">Cookie Cutters</a></li>
                            <li><a href="#" className="hover:text-yellow-400 transition-colors">Organizers</a></li>
                            <li><a href="#" className="hover:text-yellow-400 transition-colors">Spare Parts</a></li>
